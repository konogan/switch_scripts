...
async function generate_report(preflight, vignette, report, job) {
    ...
    let jsonreport = await xml2js_1.default.parseStringPromise(xml, { trim: true, normalize: true, explicitArray: false, ignoreAttrs: false, mergeAttrs: true })
        .then(function (res) {
